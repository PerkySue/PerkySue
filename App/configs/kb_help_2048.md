...
- Stop/cancel: **Alt+Q** (global). **Re-paste latest finalized result:** **Alt+R** (foreground window). AltGr works (Ctrl+Alt). Edit in Shortcuts or `Data/Configs/config.yaml`.
