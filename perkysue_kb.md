...
- Cross-mode chat memory (Pro): **Inject all modes in chat** (`llm.inject_all_modes_in_chat`) controls whether non-Alt+A LLM modes are appended to shared Ask history. Factory default is **Off**.
